...
if not User.objects.filter(username=admin_username).exists():
    ...
    print(fʼSuperuser created: {admin_username} / {admin_password}')
else:
    u = User.objects.get(username=admin_username)
    u.set_password(admin_password)
    u.save()
    print(fʼSuperuser password updated for: {admin_username}')
...
leaders_data = [
    ...
    },
    {
        ...
        'full_bio': 'Sunʼiy intellekt va dasturlash sohasidagi innovator. Bir necha xalqaro hackathonlar g‘olibi va AI platformasi muallifi.',
    ...
    },
    {
        ...
        'full_bio': 'Xalqaro toifadagi sport ustasi, Olimpiya o‘yinlari oltin medali sohibasi.',
    ...
    },
    {
        ...
        'full_bio': 'Tibbiyot fanlari nomzodi, biotexnologiyalar va genom tadqiqotlari bo‘yicha izlanuvchi.',
...
for ldata in leaders_data:
    ...
    if leader:
        ...
        print(fʼLeader updated: {leader.name} -> slug: {leader.slug}')
    else:
        ...
        print(fʼLeader created: {new_leader.name} -> slug: {new_leader.slug}')
...
if not Journal.objects.filter(issue_number=1).exists():
    Journal.objects.create(
        ...
        description='Ushbu jurnalda O‘zbekistonning turli sohalarida ulkan zafarlarga erishgan eng faol va ilhomlantiruvchi yosh yetakchilarning hayotiy tajribalari aks etgan.',
