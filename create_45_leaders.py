...
RAW_LEADERS = [
    ...
    ("Alimov Javohir Otabekovich", "texno", "Samarqand", "M", "Sunʻiy Intellekt Innovatori & Engineer", "AI platformalari muallifi, xalqaro hackathonlar 1-oʻrin sohibi va IT ekotizim tashabbuskori.", "10-iyun 2000-yil", "Samarqand shahri", "Oliy (INHA University)", "Texnologiya — bu faqat vosita. Asosiy kuch — insonning ijodiy tafakkurida."),
    ...
    ("Nazarova Rayhona Shavkatovna", "sanat", "Xorazm", "F", "Xalqaro Dizayner & Art Director", "Zamonaviy etno-dizayn yoʻnalishi vakili, Parij va Milan moda haftaliklari qatnashchisi.", "4-aprel 2002-yil", "Xiva shahri", "Oliy (Milliy Rassomlik va Dizayn Instituti)", "Sanʻat — bu millat ruhining zamonaviy shaklda namoyon boʻlishidir."),
    ...
    ("Azimova Madinabonu Botirovna", "sanat", "Samarqand", "F", "Simfonik Orkestr Dirijyori & Kompozitor", "Xalqaro kompozitorlar tanlovi sovrindori, milliy va mumtoz kuylar targʻibotchisi.", "19-dekabr 1998-yil", "Samarqand shahri", "Oliy (Oʻzbekiston Davlat Konservatoriyasi)", "Musiqa — qalbning eng samimiy va sheʻriy tilidir."),
    ...
    ("Oripova Sevinch Farhodovna", "ijtimoiy", "Sirdaryo", "F", "Inkluziv Taʻlim & Eco-Activist", "Imkoniyati cheklangan yoshlar uchun raqamli koʻnikmalar markazi rahbari.", "25-noyabr 2001-yil", "Guliston shahri", "Oliy (Guliston Davlat Universiteti)", "Teng imkoniyatlar yaratish — bu adolatli jamiyat qurishning asosidir."),
    ...
    ("Jalilova Kamola Ilhomovna", "sanat", "Qoraqalpogʻiston", "F", "Etnografik Liboslar Dizayneri", "Qoraqalpoq milliy bezaklarini zamonaviy uslubga tatbiq etayotgan dizayner.", "13-may 2000-yil", "Nukus shahri", "Oliy (Nukus Davlat Sanʻat Instituti)", "Milliy qadriyatlarimiz — ilhomimizning tuganmas manbaidir."),
    ("Boboyev Bekzod Olimovich", "sport", "Samarqand", "M", "Shaxmat Boʻyicha Xalqaro Grossmeyster", "Xalqaro shaxmat turnirlari gʻolibi, intellektual shaxmat akademiyasi ustozi.", "21-oktabr 2003-yil", "Samarqand shahri", "Oliy (SamDU)", "Shaxmat taxtasidagi kabi hayotda ham har bir yurish masʻuliyat talab qiladi."),
    ...
    ("Rahmatullayev Dostonbek Komilovich", "biznes", "Namangan", "M", "Tekstil va Tikuvchilik Klasteri CEO", "1500 dan ortiq xotin-qizlarni ish bilan taʻminlagan eksportyor tadbirkor.", "24-dekabr 1995-yil", "Namangan shahri", "Oliy (Namangan Muhandislik Instituti)", "Mehnat va halollik — doimiy va barqaror muvaffaqiyat garovidir."),
    ("Qurbonova Dilnavoz Alisher qizi", "sanat", "Buxoro", "F", "Miniatura va Xattotlik Ustozi", "Buxoro miniatyura maktabini qayta tiklayotgan va xalqaro koʻrgazmalar gʻolibi.", "6-iyul 2001-yil", "Buxoro shahri", "Oliy (Buxoro Davlat Universiteti)", "Sanʻatda har bir chiziq va rang inson ruhining aksidir."),
    ("Yusupov Shohruhbek Akramovich", "tibbiyot", "Samarqand", "M", "Kardiolog & Sunʻiy Yurak Tizimlari", "Yurak-qon tomir kasalliklarini barvaqt aniqlash boʻyicha startap asoschisi.", "19-sentyabr 1996-yil", "Samarqand shahri", "Oliy (Samarqand Tibbiyot Universiteti)", "Urayotgan har bir yurak — bizga bildirilgan yuksak ishonchdir."),
    ...
    ("Tohirova Mohinur Rustamovna", "fan", "Toshkent viloyati", "F", "Astrofizik va Kosmik Tadqiqotchi", "Oʻzbekistonda birinchi kosmik nanosum sunʻiy yoʻldoshi loyihasi ishtirokchisi.", "27-aprel 2000-yil", "Olmaliq shahri", "Oliy (OʻzMU)", "Koinotni oʻrganish — insoniyatning oʻz kelajagini tushunishidir."),
    ...
    ("Boʻriyeva Nargiza Otabek qizi", "ijtimoiy", "Qashqadaryo", "F", "Qishloq Qizlari Taʻlimi Tashabbuskori", "Olis qishloqlardagi 5000 dan ortiq qizlarga IT va ingliz tili darslarini tashkil etgan.", "14-noyabr 2001-yil", "Shahrisabz shahri", "Oliy (Toshkent Davlat Pedagogika Universiteti)", "Bir qizni oʻqitsangiz — butun bir oilani va jamiyatni oʻqitgan boʻlasiz."),
    ("Xolmurodov Doniyor Sunnatovich", "sanat", "Toshkent", "M", "Kino Rejissyor va Hujjatli Film Ustasi", "Xalqaro kinofestivallar gʻolibi, Oʻzbekiston yoshlari haqidagi filmlar rejissyori.", "22-iyun 1999-yil", "Toshkent shahri", "Oliy (Oʻzbekiston Davlat Sanʻat va Madaniyat Instituti)", "Kino — bu insonlar qalbiga yetib boruvchi eng kuchli til."),
    ...
    ("Sulaymonova Diyora Ulugʻbek qizi", "sanat", "Toshkent", "F", "Teatr Aktrisasi & Boshlovchi", "Davlat teatri aktrisasi, bir necha nufuzli sahna asarlari bosh rol ijrochisi.", "26-iyun 2001-yil", "Toshkent shahri", "Oliy (Sanʻat va Madaniyat Instituti)", "Sahna — bu haqiqat va samimiyat sinovdan oʻtadigan muqaddas maskandir."),
    ("Yoqubov Sherali Bahromovich", "texno", "Toshkent viloyati", "M", "Data Science & Big Analytics Lead", "Katta maʻlumotlarni tahlil qilish va prognozlash modellarini yaratuvchi analitik.", "4-noyabr 1997-yil", "Angren shahri", "Oliy (TUIT)", "Maʻlumotlar — bu yangi davrning eng qimmatli xomashyosidir."),
