...
coming_soon_html = """
        ...
        <div style="background: var(--bg-surface); border: 1px solid rgba(0, 166, 235, 0.35); border-radius: var(--radius-xl); padding: 70px 40px; text-align: center; backdrop-filter: blur(24px); box-shadow: 0 35px 100px rgba(0,0,0,0.7); max-width: 840px; margin: 40px auto 80px; position: relative; overflow: hidden;" class="reveal">
          ...
          <p style="font-size: 1.15rem; color: var(--text-secondary); line-height: 1.7; max-width: 650px; margin: 0 auto 36px;">O‘zbekiston Yetakchi Yoshlari jurnalining navbatdagi maxsus soni tayyorlanmoqda. Tez kunda yangi va ilhomlantiruvchi hikoyalar bilan qaytamiz!</p>
          ...
          <div class="mag-info-block">
            ...
            <div class="mag-specs-grid">
              <div class="spec-box">
                ...
                <span>{% if journal.author and journal.author != "O‘zbekiston Yetakchi Yoshlari" %}{{ journal.author }}{% else %}O‘zbekiston Yetakchi Yoshlari{% endif %}</span>
              </div>
              <div class="spec-box">
        ...
        <div class="flipbook-stage-wrapper reveal" id="flipbook-stage">
          ...
          <div class="flipbook-toolbar">
            ...
            <div class="toolbar-group">
              ...
              <button class="tool-btn" id="tb-fullscreen">To‘liq ekran</button>
            </div>
          </div>
              ...
              <div class="fpage fpage-inner" data-density="soft">
                <div class="fpage-content">
                  <div class="mag-page-header">
                    <span>O‘zYYE JURNALI — {{ journal.issue_number }}-SON</span>
                    <span>YETAKCHI YOSHLAR</span>
                  </div>
                  <div class="page-section-title">02 | JURNAL HAQIDA</div>
                  <div class="page-author">O‘zbekiston Yetakchi Yoshlari</div>
                  <div class="page-body">
                    <p>Ushbu elektron jurnal O‘zbekistonning turli sohalarida yutuqlarga erishayotgan faol yoshlarning tajribasi, maslahatlari hamda ilhomlantiruvchi hikoyalarini jamlagan loyihadir.</p>
                  ...
                  <div class="mag-page-footer">
                    <span>O‘zbekiston Yetakchi Yoshlari</span>
